...
public class Banking implements Strategy {
    ...
    int GEM = Main.GEM_ID; //still seems neater than before
    ...
    public void execute() { //
        SceneObject[] BANK_BOOTH = SceneObjects.getNearest(2213); //need dem obj's

        if (BANK_BOOTH != null && BANK_BOOTH.length > 0 && Game.getOpenInterfaceId() != 5292) { //bank booth isn't null and is there
        BANK_BOOTH[0].interact(0); //interact with bank booth
